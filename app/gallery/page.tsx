    ...
    <main className="min-h-screen bg-stone-50 text-black">
      <section className="max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
          Restaurez vos anciennes photos, colorisez-les et créez un album souvenir prêt à imprimer.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-600">Sélectionnez une ancienne photo depuis votre ordinateur.</p>
          </div>

          <div className="bg-white p-8 rounded-3xl shadow-sm">
            <h3 className="text-2xl font-bold mb-3">2. L’IA restaure</h3>
            <p className="text-gray-600">La photo est améliorée, restaurée et préparée en haute qualité.</p>
          </div>

          <div className="bg-white p-8 rounded-3xl shadow-sm">
            <h3 className="text-2xl font-bold mb-3">3. Téléchargez</h3>
            <p className="text-gray-600">Retrouvez vos photos restaurées dans votre galerie.</p>
          </div>
        </div>
      </section>
    </main>
